...
window.addEventListener("DOMContentLoaded", async function () {
    ...
    renderNavbar(user, "/admin/assign.html");
...
document.getElementById("assignForm").addEventListener("submit", async function (event) {
    ...
    // .value of a <select> = the value attribute of the chosen <option>
    const body = {
    ...
    // DATA FLOW: POST /api/enrollments -> EnrollmentController.Assign -> EnrollmentService
